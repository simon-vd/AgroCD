...
## 3. Namespace Definition (`namespace.yaml`)
...
## 6. Database Layer (`database.yaml`)
...
## 8. GitOps with Argo CD (`argo-cd.yaml`)
...
## 9. Prometheus Ingress Configuration (`prometheus.yaml`)
...
## 10. Prometheus Ingress Configuration (`prometheus.yaml`)
